...
class AirlineCompanyTest {
    ...
    @BeforeEach
    void setup() {
        company = new AirlineCompany("Mamba");
    ...
    void addFlight() {
        ...
        Flight flight1 = new Flight("AB123", "New York", "Los Angeles",
                LocalDateTime.parse("2024-11-11 10:00", formatter),
                LocalDateTime.parse("2024-11-11 15:00", formatter),
        ...
        // Edge case: overlapping flight
        Flight flight3 = new Flight("", "New York", "Los Angeles",
                LocalDateTime.parse("2024-11-11 10:00", formatter),
                LocalDateTime.parse("2024-11-11 15:00", formatter),
                160, new ArrayList<>(), new ArrayList<>());
        assertThrows(IllegalArgumentException.class, () -> company.addFlight(flight3));

        // Edge case: null value
        Flight flight4 = new Flight("", "New York", "Los Angeles",
                LocalDateTime.parse("", formatter),
                LocalDateTime.parse("2024-11-11 15:00", formatter),
                160, new ArrayList<>(), new ArrayList<>());
        assertThrows(IllegalArgumentException.class, () -> company.addFlight(flight4));
    }
    ...
    void delayFlight() {
        // Add a flight
        Flight flight1 = new Flight("AB123", "New York", "Los Angeles",
                LocalDateTime.parse("2024-11-24 10:00", formatter),
                LocalDateTime.parse("2024-11-24 14:00", formatter),
                160, new ArrayList<>(), new ArrayList<>());
        company.addFlight(flight1);

        // Normal case: Delay the flight
        company.delayFlight("AB123", LocalDateTime.parse("2024-11-24 12:00", formatter),
                LocalDateTime.parse("2024-11-24 16:00", formatter));
        assertEquals(LocalDateTime.parse("2024-11-24 12:00", formatter),
                company.getFlightDetails("AB123").getDepartureTime());

        // Edge case: Delay time earlier than original time
        assertThrows(IllegalArgumentException.class, () -> company.delayFlight("AB123",
                LocalDateTime.parse("2024-11-24 08:00", formatter),
                LocalDateTime.parse("2024-11-24 12:00", formatter)));
    ...
    void getAllFlights() {
        ...
        Flight flight2 = new Flight("CD456", "Beijing", "Shanghai",
                LocalDateTime.parse("2024-11-25 08:00", formatter),
                LocalDateTime.parse("2024-11-25 11:00", formatter),
                160, new ArrayList<>(), new ArrayList<>());
        company.addFlight(flight1);
    ...
    void getPopularRoutes() {
        ...
        Flight flight3 = new Flight("EF789", "China", "Japan",
                LocalDateTime.parse("2024-11-26 11:30", formatter),
                LocalDateTime.parse("2024-11-26 14:00", formatter),
                160, new ArrayList<>(), new ArrayList<>());
        company.addFlight(flight1);
        company.addFlight(flight2);
        ...
        assertEquals("New York - Los Angeles (2 flights)", company.getPopularRoutes().get(0));
    }
    ...
    void getNearlyFullFlights() {
        ...
        assertEquals("AB123", company.getNearlyFullFlights().get(0).getFlightNumber());
    }
}
